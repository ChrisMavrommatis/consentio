...
// Module
var consentio_consent_item_code = `<consentio-consent-item id="{{ consentKey }}"> <div class="consent-header" role="button" tabindex="0" aria-expanded="false" aria-controls="{{ consentKey }}_body"> <h5 id="{{ consentKey }}_title">{{ consentTitle }}</h5> <consentio-switch> <label> <input name="{{ consentKey }}_cookies" id="{{ consentKey }}_cookies" type="checkbox" autocomplete="off"/> <span class="switch-lever"></span> </label> </consentio-switch> </div> <div class="consent-body" id="{{ consentKey }}_body" style="display:none"> <span>{{ consentDescription }}</span> </div> </consentio-consent-item> `;
// Exports
/* harmony default export */ const consentio_consent_item = (consentio_consent_item_code);
;// ./src/templates/consentio-floating-button.html
// Module
 ...
 */
class ConsentioGTM {
    constructor(logger, signalMap = DEFAULT_SIGNAL_MAP) {
        this.logger = logger;
...
/* harmony default export */ const gtm = (ConsentioGTM);
...
/* harmony default export */ const lib_focus = (FocusTrap);
...
class ConsentioAppElement extends HTMLElement {
    constructor() {
        ...
        this._focus = new lib_focus(this._shadow);
...
/* harmony default export */ const elements_consentio_bar = (ConsentioBarElement);

;// ./src/elements/consentio-required.ts
...
;// ./src/elements/consentio-floating-button.ts
...
/* harmony default export */ const elements_consentio_floating_button = (ConsentioFloatingButtonElement);

;// ./src/elements/consentio-consent-item.ts
...
class ConsentioConsentItemElement extends HTMLElement {
    ...
    // Queried on access: a constructor runs before its children exist. Issue 11.
    get consentBody() {
        return this.querySelector('.consent-body');
    }
    get consentHeader() {
        return this.querySelector('.consent-header');
    }
    get switch() {
        return this.querySelector('consentio-switch');
    }
    get input() {
        return this.querySelector('consentio-switch input');
    }
    set alwaysOn(value) {
...
/* harmony default export */ const elements_consentio_consent_item = (ConsentioConsentItemElement);

;// ./src/elements/consentio-modal.ts
class ConsentioModalElement extends HTMLElement {
    ...
    // Queried on access: a constructor runs before its children exist. Issue 11.
    get cancelBtn() {
        return this.querySelector('[data-role="cancel"]');
    }
    get saveBtn() {
        return this.querySelector('[data-role="save"]');
    }
    get consents() {
        return Array.from(this.querySelectorAll('consentio-consent-item'));
    }
    get logger() {
        return this._logger;
    }
...
class Consentio {
    ...
    defineCustomElements() {
        const elements = [
            ['consentio-app', consentio_app],
            ['consentio-bar', elements_consentio_bar],
            ['consentio-required', consentio_required],
            ['consentio-floating-button', elements_consentio_floating_button],
            ['consentio-consent-item', elements_consentio_consent_item],
            ['consentio-modal', elements_consentio_modal]
        ];
