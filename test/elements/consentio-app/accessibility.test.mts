...
test('issue 14 - the blocking overlay does not trap a keyboard user with no way out', () => {
...
test('issue 14 - the bar announces itself as a region rather than as anonymous markup', () => {
